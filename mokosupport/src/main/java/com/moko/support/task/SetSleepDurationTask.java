 ...
 * @Author wenzheng.liu
 * @Description 
 * @ClassPath com.moko.support.task.SetSleepDurationTask
 */
public class SetSleepDurationTask extends OrderTask {

    public byte[] data;

    public SetSleepDurationTask(MokoOrderTaskCallback callback, int sendDataType) {
