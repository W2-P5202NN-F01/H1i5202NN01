 ...
 * @Author wenzheng.liu
 * @Description 
 * @ClassPath com.moko.support.task.SetAdvPeriodTask
 */
public class SetAdvPeriodTask extends OrderTask {

    public byte[] data;

    public SetAdvPeriodTask(MokoOrderTaskCallback callback, int sendDataType) {
