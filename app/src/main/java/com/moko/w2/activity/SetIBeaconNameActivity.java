 ...
 * @Author wenzheng.liu
 * @Description
 * @ClassPath com.moko.w2.activity.SetIBeaconNameActivity
 */
public class SetIBeaconNameActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        InputFilter[] filters = {new InputFilter.LengthFilter(9), filter};
        ...
        tvTips.setText(getString(R.string.tips_ibeacon_name));
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_save:
                ...
                if (etIBeaconName.getText().toString().length() > (9)) {
