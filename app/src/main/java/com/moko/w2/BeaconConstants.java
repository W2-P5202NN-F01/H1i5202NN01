...
public class BeaconConstants {
    ...
    public static final String EXTRA_KEY_DEVICE_ADV_PERIOD = "EXTRA_KEY_DEVICE_ADV_PERIOD";
    public static final String EXTRA_KEY_DEVICE_WAKE_UP_INTERVAL = "EXTRA_KEY_DEVICE_WAKE_UP_INTERVAL";
    public static final String EXTRA_KEY_DEVICE_SLEEP_DURATION = "EXTRA_KEY_DEVICE_SLEEP_DURATION";
    // request_code
    ...
    public static final int REQUEST_CODE_SET_ADV_PERIOD = 114;
    public static final int REQUEST_CODE_SET_WAKE_UP_INTERVAL = 115;
    public static final int REQUEST_CODE_SET_SLEEP_DURATION = 116;
